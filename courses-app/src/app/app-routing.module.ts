...
const routes: Routes = [
  ...
  {path: 'courses/edit/:id', loadChildren: () => import('./features/edit-course/edit-course.module').then(m => m.EditCourseModule), canLoad: [AuthorizedGuard], canActivate: [AdminGuard]},
  {path: 'courses/add', loadChildren: () => import('./features/add-course/add-course.module').then(m => m.AddCourseModule), canLoad: [AuthorizedGuard], canActivate: [AdminGuard] },
